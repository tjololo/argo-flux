...
# curl -X POST \
#     -F 'db_type=MySQL' \
#     -F 'db_host=gitea-mariadb:3306' \
#     -F 'db_user=gitea' \
#     -F "db_password=$DB_PASSWORD" \
#     -F 'db_name=gitea' \
#     -F 'charset=utf8' \
#     -F 'db_path=data/gitea.db' \
#     -F 'app_name=Gitea: Git with a cup of tea' \
#     -F 'repo_root_path=/data/git/gitea-repositories' \
#     -F 'lfs_root_path=/app/gitea/data/lfs' \
#     -F 'run_user=git' \
#     -F 'domain=gitea.127.0.0.1.xip.io' \
#     -F 'ssh_port=8022' \
#     -F 'http_port=3000' \
#     -F 'app_url=http://gitea.127.0.0.1.xip.io/' \
#     -F 'log_root_path=/app/gitea/log' \
